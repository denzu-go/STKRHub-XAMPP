    ...
    <main>
      ...
      <div class="body">
        <div class="container-body">
          <!-- TODO:TODO:TODO:TODO: -->
          <section id="allcomponents" class="section section-active">
                      ...
                      <div class="col-xs-3 col-xs-offset-3">
                        <div class="input-group number-spinner">
                          <div class="quantity-container">
                            <div class="q1">
                              <input id="quantity-input" type="number" class="form-control component-quantity" value="1" min="1" max="99" onchange="detect()" />
                            </div>
                            <span id="result"></span>
                          </div>
                        </div>
